...
public class WeatherForecastController : ControllerBase
{
    ...
    public async Task<IActionResult> Get()
    {
        ...
        var contractAddress = "0xfE1d7f7a8f0bdA6E415593a2e4F82c64b446d404";
        var contractAbi = """
        ...
        // Call a read-only function (e.g., get balance)
        var balance = await contract.GetFunction("totalSupply").CallAsync<BigInteger>();
